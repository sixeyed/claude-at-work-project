...
Feature: Permissions
  ...
  public channel belongs to the whole workspace — anyone there can find it in
  their channel list, open it and see who else is in it. A private channel
  belongs to the people in it, and to everyone else it simply is not there:
  following a link to one looks exactly like following a link to a channel that
  never existed, because saying "you may not open this" would already give away
  that it exists.
